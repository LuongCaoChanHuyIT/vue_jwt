        ...
        <div class="main-menu">
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect' href='/lunoz/'>
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect' href='/lunoz/apps-calendar'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuExpages">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/pages-starter'>
                                        <span class="menu-text">Starter</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/pages-invoice'>
                                        <span class="menu-text">Invoice</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/pages-login'>
                                        <span class="menu-text">Log In</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/pages-register'>
                                        <span class="menu-text">Register</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/pages-recoverpw'>
                                        <span class="menu-text">Recover Password</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/pages-lock-screen'>
                                        <span class="menu-text">Lock Screen</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/pages-404'>
                                        <span class="menu-text">Error 404</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/pages-500'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuLayouts">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/layout-horizontal'>
                                        <span class="menu-text">Horizontal</span>
                                    </a>
                                </li>

                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/layout-sidenav-light'>
                                        <span class="menu-text">Sidenav Light</span>
                                    </a>
                                </li>

                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/layout-sidenav-brand'>
                                        <span class="menu-text">Sidenav Brand</span>
                                    </a>
                                </li>

                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/layout-topbar-dark'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuComponentsui">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-alerts'>
                                        <span class="menu-text">Alerts</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-buttons'>
                                        <span class="menu-text">Buttons</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-cards'>
                                        <span class="menu-text">Cards</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-carousel'>
                                        <span class="menu-text">Carousel</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-dropdowns'>
                                        <span class="menu-text">Dropdowns</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-video'>
                                        <span class="menu-text">Embed Video</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-general'>
                                        <span class="menu-text">General UI</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-grid'>
                                        <span class="menu-text">Grid</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-images'>
                                        <span class="menu-text">Images</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-list-group'>
                                        <span class="menu-text">List Group</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-modals'>
                                        <span class="menu-text">Modals</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-offcanvas'>
                                        <span class="menu-text">Offcanvas</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-placeholders'>
                                        <span class="menu-text">Placeholders</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-progress'>
                                        <span class="menu-text">Progress</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-spinners'>
                                        <span class="menu-text">Spinners</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-tabs-accordions'>
                                        <span class="menu-text">Tabs & Accordions</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-tooltips-popovers'>
                                        <span class="menu-text">Tooltips & Popovers</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/ui-typography'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuExtendedui">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/components-range-slider'>
                                        <span class="menu-text">Range Slider</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/components-sweet-alert'>
                                        <span class="menu-text">Sweet Alert</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/components-loading-buttons'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuIcons">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/icons-boxicons'>
                                        <span class="menu-text">Boxicons Icons</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/icons-lucide'>
                                        <span class="menu-text">Lucide Icons</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/icons-mdi'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuForms">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/forms-elements'>
                                        <span class="menu-text">General Elements</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/forms-advanced'>
                                        <span class="menu-text">Advanced</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/forms-validation'>
                                        <span class="menu-text">Validation</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/forms-quilljs'>
                                        <span class="menu-text">Editor</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/forms-file-uploads'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuTables">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/tables-basic'>
                                        <span class="menu-text">Basic Tables</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/tables-datatables'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuCharts">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/charts-apex'>
                                        <span class="menu-text">Apex Charts</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/charts-morris'>
                                        <span class="menu-text">Morris Charts</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/charts-chartjs'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuMaps">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/maps-google'>
                                        <span class="menu-text">Google Maps</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href='/lunoz/maps-vector'>
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-4">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <!-- item-->
                                <a class='dropdown-item notify-item' href='/lunoz/pages-lock-screen'>
                                ...
                                <!-- item-->
                                <a class='dropdown-item notify-item' href='/lunoz/pages-login'>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <i class="bx bx-bx bx-analyse float-end m-0 h2 text-muted"></i>
                                    <h6 class="text-muted text-uppercase mt-0">Average Price</h6>
                                    <h3 class="mb-3">$<span data-plugin="counterup">15.9</span></h3>
                                    <span class="badge bg-warning me-1"> 0% </span> <span class="text-muted">From previous period</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <span class="badge bg-success me-1"> +89% </span> <span class="text-muted">Last year</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table table-centered table-hover table-xl mb-0" id="recent-orders">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-soft-success p-1">Mobile</span>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-soft-success p-1">Tablet</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress" style="height: 6px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-soft-success p-1">Electronics</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress" style="height: 6px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-soft-success p-1">Cosmetics</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress" style="height: 6px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-soft-success p-1">Appliences</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress" style="height: 6px;">
