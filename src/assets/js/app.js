class ThemeLayout {
  ...
  initComponents() {
        ...
        (n &&
          n.addEventListener('click', function (e) {
            var t = document.documentElement,
              n = 'light' === t.getAttribute('data-bs-theme') ? 'dark' : 'light';
    ...
    (document.documentElement.setAttribute('data-bs-theme', n),
      sessionStorage.setItem('themeMode', n));
  }
    ...
    ($('.app-menu').length &&
      ...
      setTimeout(function () {
        ...
        function s() {
          ...
          var e,
            t,
            n = (e /= l / 2) < 1 ? (n / 2) * e * e + t : (-n / 2) * (--e * (e - 2) - 1) + t;
          ((o.scrollTop = n), d < l && setTimeout(s, 20));
        }
        null != t &&
          ((e = document.querySelector('.main-menu .simplebar-content-wrapper')),
          (t = t.offsetTop - 300),
          e && 100 < t && ((l = 600), (a = (o = e).scrollTop), (c = t - a), (d = 0), s()));
      }, 200));
  }
  reverseQuery(e, t) {
    for (; e; ) {
  ...
  initSwitchListener() {
    ...
    t &&
      t.addEventListener('click', function () {
        ...
        ('full' === e.html.getAttribute('data-sidebar-size') && e.showBackdrop(),
